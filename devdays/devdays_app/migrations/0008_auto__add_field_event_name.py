...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('devdays_app_event', 'name',
                      self.gf('django.db.models.fields.CharField')(default='Some DEVDAYAS EVENT', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.name'
        db.delete_column('devdays_app_event', 'name')
    ...
    models = {
        ...
        'devdays_app.event': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'default': "'Some DEVDAYAS EVENT'", 'max_length': '100'}),
