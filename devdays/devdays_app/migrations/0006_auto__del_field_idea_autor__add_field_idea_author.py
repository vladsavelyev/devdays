...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Idea.autor'
        db.delete_column('devdays_app_idea', 'autor_id')

        # Adding field 'Idea.author'
        db.add_column('devdays_app_idea', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='AuthorUserProfile', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Idea.autor'
        db.add_column('devdays_app_idea', 'autor',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='AutorUserProfile', null=True, to=orm['auth.User'], blank=True),
                      keep_default=False)

        # Deleting field 'Idea.author'
        db.delete_column('devdays_app_idea', 'author_id')
