...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProjectUsers'
        db.create_table('devdays_app_projectusers', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['devdays_app.Project'])),
            ('date_joined', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal('devdays_app', ['ProjectUsers'])
    ...
    def backwards(self, orm):
        # Deleting model 'ProjectUsers'
        db.delete_table('devdays_app_projectusers')
