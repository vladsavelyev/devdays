...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProjectUsers.date_joined'
        db.alter_column('devdays_app_projectusers', 'date_joined', self.gf('django.db.models.fields.DateField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'ProjectUsers.date_joined'
        db.alter_column('devdays_app_projectusers', 'date_joined', self.gf('django.db.models.fields.DateField')())
