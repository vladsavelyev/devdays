...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('devdays_app_event', 'state',
                      self.gf('django.db.models.fields.CharField')(default='initial', max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Event.state'
        db.delete_column('devdays_app_event', 'state')
