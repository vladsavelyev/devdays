...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Project.opened_issues'
        db.add_column('devdays_app_project', 'opened_issues',
                      self.gf('django.db.models.fields.IntegerField')(default=-1, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Project.closed_issues'
        db.add_column('devdays_app_project', 'closed_issues',
                      self.gf('django.db.models.fields.IntegerField')(default=-1, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Project.commits'
        db.add_column('devdays_app_project', 'commits',
                      self.gf('django.db.models.fields.IntegerField')(default=-1, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Project.opened_issues'
        db.delete_column('devdays_app_project', 'opened_issues')

        # Deleting field 'Project.closed_issues'
        db.delete_column('devdays_app_project', 'closed_issues')

        # Deleting field 'Project.commits'
        db.delete_column('devdays_app_project', 'commits')
    ...
    models = {
        ...
        'devdays_app.event': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'default': "'Some DEVDAYS EVENT'", 'max_length': '100'}),
        ...
        'devdays_app.project': {
            ...
            'closed_issues': ('django.db.models.fields.IntegerField', [], {'default': '-1', 'null': 'True', 'blank': 'True'}),
            ...
            'commits': ('django.db.models.fields.IntegerField', [], {'default': '-1', 'null': 'True', 'blank': 'True'}),
            ...
            'link': ('django.db.models.fields.CharField', [], {'max_length': '1024', 'null': 'True', 'blank': 'True'}),
            'opened_issues': ('django.db.models.fields.IntegerField', [], {'default': '-1', 'null': 'True', 'blank': 'True'}),
